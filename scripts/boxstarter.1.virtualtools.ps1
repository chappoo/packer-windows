...
if (-not (Test-Path -Path "C:\Windows\Temp\windows.iso"))
{
    ...
    (New-Object System.Net.WebClient).DownloadFile("https://softwareupdate.vmware.com/cds/vmw-desktop/fusion/8.5.6/5234762/packages/com.vmware.fusion.tools.windows.zip.tar", "C:\Windows\Temp\com.vmware.fusion.tools.windows.zip.tar")
